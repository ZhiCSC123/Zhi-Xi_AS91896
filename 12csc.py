...
quiz_data = [
    ...
    {"q": "How do you know if you need to replace your oil", "options": ["If the dipstick turns black", "When your engine starts making knocking sounds", "The sticker on the windshield", "When the oil on the dip stick goes below the marked line"], "a": "When the oil on the dip stick goes below the marked line"},
    {"q": "What is the purpose of a muffler?", "options": ["Regulate exhaust flow", "Acts as a filter...", "It is needed to prevent a car from overheating", "Maximize engine power"], "a": "Regulate exhaust flow"}
]
...
class QuizApp:
    ...
    # makes the progression bar fill up as the quiz continues
    ...
    def start_screen(self):
        ...
        self.entry.bind("<FocusOut>", lambda e: self.entry.insert(0, placeholder) if self.entry.get() == "" else None)
    ...
    def quiz_screen(self):
        ...
        self.q_label = tk.Label(top, text="", fg=WHITE, bg=BG, font=("Arial", 18, "bold"))
    ...
    def load_q(self):
        ...
        self.q_label.config(
            text=f"Question {self.q_index+1} of 10\n{q['q']}"
        )
    ...
    def result_screen(self):
        ...
        tk.Label(frame, text="You Passed!" if passed else "You Failed!",
                 fg=WHITE, bg=BG, font=("Arial", 28, "bold")).pack()
